...
![Группировка по проекту](docs/screenshots/ru/07-grouping.png)
...
![Новая задача — сроки, связи, время](docs/screenshots/ru/08-new-task-advanced.png)
...
![Редактор — расширенные поля](docs/screenshots/ru/09-edit-advanced.png)
